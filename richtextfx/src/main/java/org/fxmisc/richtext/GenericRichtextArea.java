 ...
 */
public class GenericRichtextArea<PS, SEG, S> extends Region
        implements
     ...
     */
    public GenericRichtextArea(PS initialParagraphStyle, BiConsumer<TextFlow, PS> applyParagraphStyle,
    ...
    public GenericRichtextArea(PS initialParagraphStyle, BiConsumer<TextFlow, PS> applyParagraphStyle,
        ...
        getStylesheets().add(GenericRichtextArea.class.getResource("styled-text-area.css").toExternalForm());
    ...
    private Cell<Paragraph<PS, SEG, S>, ParagraphBox<PS, SEG, S>> createCell(
        ...
        ParagraphBox<PS, SEG, S> box = new ParagraphBox<>(paragraph, applyParagraphStyle, applyStyle, segmentOps);
        ...
        ObjectBinding<IndexRange> cellSelection = Bindings.createObjectBinding(() -> {
            ...
            return idx != -1
                    ...
                    : GenericRichtextArea.EMPTY_RANGE;
