...
public class StyledTextArea<S, PS> extends Region
    ...
    public void setStyleCodecs(Codec<S> textStyleCodec, Codec<PS> paragraphStyleCodec) {
        model.setStyleCodecs(textStyleCodec, paragraphStyleCodec);
    }
    @Override
    public Optional<Tuple2<Codec<S>, Codec<PS>>> getStyleCodecs() {
        return model.getStyleCodecs();
    }
    ...
    // rich text
    @Override public final StyledDocument<S, PS> getDocument() { return model.getDocument(); };
    ...
    // rich text changes
    @Override public final EventStream<RichTextChange<S, PS>> richChanges() { return model.richChanges(); }
     ...
     * model model
     */
    private final StyledTextAreaModel<S, PS> model;
     ...
     */
    protected final StyledTextAreaModel<S, PS> getModel() {
        return model;
    }
     ...
     */
    protected final BiConsumer<? super TextExt, S> getApplyStyle() { return model.getApplyStyle(); }

    /**
     * Style applicator used by the default skin.
     */
    protected final BiConsumer<TextFlow, PS> getApplyParagraphStyle() { return model.getApplyParagraphStyle(); }
    ...
    public <C> StyledTextArea(S initialStyle, BiConsumer<? super TextExt, S> applyStyle,
        ...
        this(new StyledTextAreaModel<S, PS>(initialStyle, applyStyle, initialParagraphStyle, applyParagraphStyle,
    ...
    public StyledTextArea(S initialStyle, BiConsumer<? super TextExt, S> applyStyle,
        ...
        this(new StyledTextAreaModel<>(initialStyle, applyStyle, initialParagraphStyle, applyParagraphStyle, document, true));

    }

    public StyledTextArea(StyledTextAreaModel<S, PS> model) {
        this.model = model;
