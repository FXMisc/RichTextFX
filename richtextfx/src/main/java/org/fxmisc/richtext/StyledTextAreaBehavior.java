...
class StyledTextAreaBehavior implements Behavior {
    ...
    static {
        ...
        EventHandlerTemplate<StyledTextAreaBehavior, KeyEvent> edits = EventHandlerTemplate
                ...
                // cut
                .on(keyPressed(CUT))               .act((b, e) -> b.model.cut())
                .on(keyPressed(X, SHORTCUT_DOWN))  .act((b, e) -> b.model.cut())
                .on(keyPressed(DELETE, SHIFT_DOWN)).act((b, e) -> b.model.cut())
                // paste
                .on(keyPressed(PASTE))             .act((b, e) -> b.model.paste())
                .on(keyPressed(V, SHORTCUT_DOWN))  .act((b, e) -> b.model.paste())
                .on(keyPressed(INSERT, SHIFT_DOWN)).act((b, e) -> b.model.paste())
                // tab & newline
        ...
        EventHandlerTemplate<StyledTextAreaBehavior, KeyEvent> otherActions = EventHandlerTemplate
                .<StyledTextAreaBehavior, KeyEvent, KeyEvent>
                // copy
                 on(keyPressed(COPY))                 .act((b, e) -> b.model.copy())
                .on(keyPressed(C,      SHORTCUT_DOWN)).act((b, e) -> b.model.copy())
                .on(keyPressed(INSERT, SHORTCUT_DOWN)).act((b, e) -> b.model.copy())
                .create();
    ...
    StyledTextAreaBehavior(StyledTextArea<?, ?> area, StyledTextAreaModel<?, ?> model) {
        this.view = area;
        this.model = model;
