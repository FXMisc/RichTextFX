...
public class GenericStyledArea<PS, SEG, S> extends Region
    ...
    @Override void setEditable(boolean value) { editable.set(value); }
    @Override boolean isEditable() { return editable.get(); }
    ...
    // Don't remove as FXMLLoader doesn't recognise default methods !
    @Override void setWrapText(boolean value) { wrapText.set(value); }
    @Override boolean isWrapText() { return wrapText.get(); }
    ...
    // Don't remove as FXMLLoader doesn't recognise default methods !
    @Override void setContextMenu(ContextMenu menu) { contextMenu.set(menu); }
    @Override ContextMenu getContextMenu() { return contextMenu.get(); }
    ...
    // Don't remove as FXMLLoader doesn't recognise default methods !
    @Override void setContextMenuXOffset(double offset) { contextMenuXOffset.set(offset); }
    @Override double getContextMenuXOffset() { return contextMenuXOffset.get(); }
    ...
    // Don't remove as FXMLLoader doesn't recognise default methods !
    @Override void setContextMenuYOffset(double offset) { contextMenuYOffset.set(offset); }
    @Override double getContextMenuYOffset() { return contextMenuYOffset.get(); }
    ...
    // Don't remove as FXMLLoader doesn't recognise default methods !
    @Override void setAutoScrollOnDragDesired(boolean val) { autoScrollOnDragDesired.set(val); }
    @Override boolean isAutoScrollOnDragDesired() { return autoScrollOnDragDesired.get(); }
