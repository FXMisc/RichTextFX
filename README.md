...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.5.1/richtextfx-demos-fat-0.5.1.jar) the pre-built "fat" JAR file and run

    java -cp richtextfx-demos-fat-0.5.1.jar org.fxmisc.richtext.demo.JavaKeywords

or

    java -cp richtextfx-demos-fat-0.5.1.jar org.fxmisc.richtext.demo.JavaKeywordsAsync
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.5.1/richtextfx-demos-fat-0.5.1.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.5.1.jar org.fxmisc.richtext.demo.RichText
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.5.1/richtextfx-demos-fat-0.5.1.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.5.1.jar org.fxmisc.richtext.demo.TooltipDemo
...
Current stable release is 0.5.1.

#### Maven coordinates

| Group ID            | Artifact ID | Version |
| :-----------------: | :---------: | :-----: |
| org.fxmisc.richtext | richtextfx  | 0.5.1   |

#### Gradle example

```groovy
dependencies {
    compile group: 'org.fxmisc.richtext', name: 'richtextfx', version: '0.5.1'
}
```
...
```scala
libraryDependencies += "org.fxmisc.richtext" % "richtextfx" % "0.5.1"
```

#### Manual download

Download [the JAR file](https://github.com/TomasMikula/RichTextFX/releases/download/v0.5.1/richtextfx-0.5.1.jar) or [the fat JAR file (including dependencies)](https://github.com/TomasMikula/RichTextFX/releases/download/v0.5.1/richtextfx-fat-0.5.1.jar) and place it on your classpath.
