...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.4.2/richtextfx-demos-fat-0.4.2.jar) the pre-built "fat" JAR file and run

    java -cp richtextfx-demos-fat-0.4.2.jar org.fxmisc.richtext.demo.JavaKeywords

or

    java -cp richtextfx-demos-fat-0.4.2.jar org.fxmisc.richtext.demo.JavaKeywordsAsync
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.4.2/richtextfx-demos-fat-0.4.2.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.4.2.jar org.fxmisc.richtext.demo.RichText
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.4.2/richtextfx-demos-fat-0.4.2.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.4.2.jar org.fxmisc.richtext.demo.TooltipDemo
...
Current stable release is 0.4.2.
...
Download [the JAR file](https://github.com/TomasMikula/RichTextFX/releases/download/v0.4.2/richtextfx-0.4.2.jar) or [the fat JAR file (including dependencies)](https://github.com/TomasMikula/RichTextFX/releases/download/v0.4.2/richtextfx-fat-0.4.2.jar) and place it on your classpath.
