...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-demos-fat-0.6.7.jar) the pre-built "fat" JAR file and run

    java -cp richtextfx-demos-fat-0.6.7.jar org.fxmisc.richtext.demo.JavaKeywords

or

    java -cp richtextfx-demos-fat-0.6.7.jar org.fxmisc.richtext.demo.JavaKeywordsAsync
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-demos-fat-0.6.7.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.6.7.jar org.fxmisc.richtext.demo.XMLEditor
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-demos-fat-0.6.7.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.6.7.jar org.fxmisc.richtext.demo.RichText
...
[Download](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-demos-fat-0.6.7.jar) the pre-built "fat" JAR file and run
    ...
    java -cp richtextfx-demos-fat-0.6.7.jar org.fxmisc.richtext.demo.TooltipDemo
...
Current stable release is 0.6.7.

#### Maven coordinates

| Group ID            | Artifact ID | Version |
| :-----------------: | :---------: | :-----: |
| org.fxmisc.richtext | richtextfx  | 0.6.7   |
...
Download [the JAR file](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-0.6.7.jar) or [the fat JAR file (including dependencies)](https://github.com/TomasMikula/RichTextFX/releases/download/v0.6.7/richtextfx-fat-0.6.7.jar) and place it on your classpath.
